...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {row_column_raw_nodebounce[0]}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {row_column_raw_nodebounce[1]}]
set_property -dict { PACKAGE_PIN W17   IOSTANDARD LVCMOS33 } [get_ports {row_column_raw_nodebounce[2]}]
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports {row_column_raw_nodebounce[3]}]
